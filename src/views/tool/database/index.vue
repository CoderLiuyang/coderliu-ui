...
<script>
import { addObj, delObj, fetchDsList, putObj } from '@/api/tool/gen'
import { formOption, tableDsOption, tableOption } from '@/const/crud/tool/gen'
...
export default {
  ...
  methods: {
    rowDel: function(row, index) {
      this.$confirm('是否确认删除名称为' + row.name+'的数据源吗？', '提示', {
