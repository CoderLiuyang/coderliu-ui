...
<!--          &lt;!&ndash;            v-if="permissions.sys_user_edit"&ndash;&gt;-->
<!--          &lt;!&ndash;            text&ndash;&gt;-->
<!--          &lt;!&ndash;            type="primary"&ndash;&gt;-->
<!--          &lt;!&ndash;            icon="el-icon-edit"&ndash;&gt;-->
<!--          &lt;!&ndash;            @click="exportPBMN(scope.row, scope.index)"&ndash;&gt;-->
<!--          &lt;!&ndash;          >导出&ndash;&gt;-->
<!--          &lt;!&ndash;          </el-button>&ndash;&gt;-->
<!--          <el-button-->
...
<!--    </basic-container>-->
<!--  </div>-->
<!--  &lt;!&ndash;  <el-dialog title="收货地址" :visible.sync="activitEditer">&ndash;&gt;-->
<!--  &lt;!&ndash;    <edit-page></edit-page>&ndash;&gt;-->
